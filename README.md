...
microgear-html5 ??? client library ???????????????? client library ??? NETPIE ???????????? web browser ??????? microgear ??????????????? microgear ?? platform ????? ???????????? arduino, raspberry pi ???? computer ????????????? IOT application ??????????? library ?????????? IOT console ???? mobile application ????????????????????????????????????? HTML/JavaScript ????????????? ??????????????????? netpie platform ????????????????? http://netpie.io
